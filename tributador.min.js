...
angular.module('app.taxsettings.services').service('MensagemService', ['GumgaRest', 'apiLocation', function (GumgaRest, apiLocation) {
...
angular.module('app.taxsettings.services').service('TaxationGroupService', ['GumgaRest', 'apiLocation', function (GumgaRest, apiLocation) {
...
angular.module('app.taxsettings.controllers', ['app.taxsettings.services', 'ui.router']);
'use strict';

angular.module('app.taxsettings.controllers').controller('ModalConflitoController', ['entity', 'values', '$scope', '$uibModalInstance', function (entity, values, $scope, $uibModalInstance) {
...
angular.module('app.taxsettings.controllers').controller('TaxSettingsFormController', ['TaxationGroupService', 'MensagemService', 'CompanyService', 'OperationTypeService', 'PersonGroupService', 'ProductGroupService', 'CfopService', 'FormulaService', '$state', 'entity', '$scope', '$timeout', '$uibModal', '$rootScope', 'CodigoEnquadramentoIpiService', 'GumgaAlert', 'gumgaController', function (TaxationGroupService, MensagemService, CompanyService, OperationTypeService, PersonGroupService, ProductGroupService, CfopService, FormulaService, $state, entity, $scope, $timeout, $uibModal, $rootScope, CodigoEnquadramentoIpiService, GumgaAlert, gumgaController) {
	...
	$scope.showSimplesSt = function (icms) {
		return icms.CSOSN === 'CREDITO_COM_ST_201' || icms.CSOSN === 'SEM_CREDITO_COM_ST_202' || icms.CSOSN === 'RECEITA_BRUTA_COM_ST_203' || icms.CSOSN === 'ANTECIPACAO_ST_500' || icms.CSOSN === 'OUTROS_900';
	};
...
angular.module('app.taxsettings.controllers').controller('TaxSettingsListController', ['TaxationGroupService', '$scope', 'gumgaController', function (TaxationGroupService, $scope, gumgaController) {
    gumgaController.createRestMethods($scope, TaxationGroupService, 'taxationGroup');
...
angular.module('app.taxsettings', ['ui.router', 'app.taxsettings.controllers', 'app.taxsettings.services', 'api.location']).config(['$stateProvider', 'apiLocation', function ($stateProvider, apiLocation) {
...
angular.module('taxsettings.core', ['ui.router', 'ngSanitize', 'gumga.core', 'brasil.filters', 'ui.utils.masks', 'datePicker', 'app.stock', 'app.taxsettings', 'tributador.templates', 'buddy.core', 'operationtype.core', 'product.core'
//FIMINJECTIONS
