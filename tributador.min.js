!function(modules) {
    ...
    module.exports = angular.module("taxsettings.core", [ "ui.router", "ngSanitize", "gumga.core", "brasil.filters", "ui.utils.masks", "datePicker", "app.stock", "app.taxsettings", "buddy.core", "operationtype.core", "product.core" ]).config(function($stateProvider) {
        $stateProvider.state("taxsettings", {
            ...
            url: "/taxsettings",
            templateUrl: "/baseGrandsComponents.html"
        });
    });
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    function TaxSettingsFormController(TaxationGroupService, MensagemService, CompanyService, OperationTypeService, PersonGroupService, ProductGroupService, CfopService, FormulaService, $state, entity, $scope, $timeout, $uibModal, $rootScope, CodigoEnquadramentoIpiService, GumgaAlert, gumgaController) {
        ...
        function doSave() {
            "taxsettings.insert" === $state.current.name ? swal({
                title: "Confirmação",
                ...
                isConfirm || $state.go("taxsettings.list");
        ...
        $scope.openTaxation = !1, $scope.step1 = !1, $scope.configOpen = !1, $scope.configOpenNext = !1, 
        $scope.mensagemICMSList = [], $scope.mensagemPISList = [], $scope.mensagemIPIList = [], 
        $scope.mensagemCOFINSList = [], $scope.formulaIcmsBCList = [], $scope.formulaValorIcms = [], 
        $scope.formulaBaseIcmsSt = [], $scope.formulaValorIcmsSt = [], $scope.formulaValorIcmsDeson = [], 
        $scope.formulaIcmsStDeson = [], $scope.fomulasBaseIcmsRet = [], $scope.formulaValorIcmsRet = [], 
        $scope.formulaBaseIcmsDest = [], $scope.formulaValorIcmsDest = [], $scope.formulaValorIcmsOpe = [], 
        $scope.formulaBasePis = [], $scope.formulaBasePisST = [], $scope.formulaValorPisST = [], 
        $scope.formulaValorPis = [], $scope.formulaBaseCofins = [], $scope.formulaBaseCofinsST = [], 
        $scope.formulaValorCofinsST = [], $scope.formulaValorCofins = [], $scope.cfopList = [], 
        $scope.stateOriginConflicts = [], $scope.stateDestinationsConflicts = [], $scope.personGroupConflicts = [], 
        $scope.productGroupConflicts = [], $scope.operationConflicts = [], $scope.entity.id && ($scope.openTaxation = !0, 
        $scope.configOpen = !1, $scope.configOpenNext = !1), CompanyService.getCurrentCompany().then(function(data) {
            ...
            $scope.pis = {}, $scope.icms = {}, $scope.cofins = {}, $scope.ipi = {}, $scope.entity.operationTypes = [], 
            $scope.entity.origins = [], $scope.entity.destinations = [], $scope.entity.personGroups = [], 
            $scope.entity.productGroups = [], $scope.entity.name = "", $scope.openTaxation = !1, 
            $scope.openPanel(), $scope.stateOriginConflicts = [], $scope.personGroupConflicts = [], 
            $scope.productGroupConflicts = [], $scope.operationConflicts = [], $scope.entity.taxationPIS = {}, 
            $scope.entity.taxationICMS = {}, $scope.entity.taxationCOFINS = {}, $scope.entity.taxationIPI = {};
        }, $scope.replicateTaxSetting = function() {
            var newEntity = angular.copy($scope.entity);
            delete newEntity.id, TaxationGroupService.newEntity = newEntity, $state.go("taxsettings.insert");
            ...
            $scope.configOpen = "configOpen" === panel, $scope.openTaxation = "openTaxation" === panel;
        }, $scope.entity.id || $scope.openPanel("configOpen"), $scope.blockBtnTributos = function(entity) {
            ...
            return $scope.icmsNormal && invalidIcmsNormal(icms) || !$scope.icmsNormal && invalidIcmsSimples(icms) || invalidPis(pis) || invalidCofins(cofins) || invalidIpi(ipi) || 0 === entity.name.length;
        }, $scope.update = function(entity, icms, pis, cofins, ipi, disabled) {
            disabled || (entity.destinations = entity.destinations.map(mapEnum), entity.origins = entity.origins.map(mapEnum), 
    ...
    "use strict";
    __webpack_require__(0), module.exports = angular.module("app.taxsettings.controllers", [ "app.taxsettings.services", "ui.router" ]).controller("TaxSettingsFormController", __webpack_require__(5)).controller("ModalConflitoController", __webpack_require__(4)).controller("TaxSettingsListController", __webpack_require__(6));
}, function(module, exports, __webpack_require__) {
    "use strict";
    __webpack_require__(7), __webpack_require__(0);
    var list = __webpack_require__(15), form = __webpack_require__(14);
        ...
        $stateProvider.state("taxsettings.list", {
            ...
            resolve: {
                entity: [ "$stateParams", "$http", "TaxationGroupService", "$q", function($stateParams, $http, TaxationGroupService, $q) {
                    ...
                    return TaxationGroupService.newEntity ? $q(function(resolve) {
                        var ent = angular.copy(TaxationGroupService.newEntity);
                        delete TaxationGroupService.newEntity, resolve({
                            data: ent
                        });
                    }) : $http.get(url);
                } ]
