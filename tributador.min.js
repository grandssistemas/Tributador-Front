!function(modules) {
    ...
    "use strict";
    module.exports = angular.module("app.taxsettings.services", [ "api.location" ]).service("MensagemService", __webpack_require__(13)).service("FormulaService", __webpack_require__(12)).service("CodigoEnquadramentoIpiService", __webpack_require__(11)).service("TaxationGroupService", __webpack_require__(14));
}, function(module, exports, __webpack_require__) {
    module.exports = __webpack_require__.p + "bower_components/tributador-front/resources/images/mobi_logo_pq.png";
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    function ModalConflitoController(entity, values, $scope, $uibModalInstance) {
        ...
        entity = angular.copy(entity), $scope.values = angular.copy(values), $scope.values = $scope.values.map(function(data) {
            return data.operationTypes = filterById(data.operationTypes, entity.operationTypes), 
            data.productTypes = filterById(data.productGroups, entity.productGroups), data.personTypes = filterById(data.personGroups, entity.personGroups), 
            data.destinations = filterByKey(data.destinations, entity.destinations), data.origins = filterByKey(data.origins, entity.origins), 
            data;
        }), $scope.conf = {
    ...
    function TaxSettingsFormController(TaxationGroupService, MensagemService, CompanyService, OperationTypeService, PersonGroupService, ProductGroupService, CfopService, FormulaService, $state, entity, $scope, $timeout, $uibModal, $rootScope, CodigoEnquadramentoIpiService, GumgaAlert, gumgaController) {
        function invalidPis(pis) {
            if (pis.CST) switch (pis.CST) {
              case "OPERACAO_TRIBUTAVEL_01":
              case "OPERACAO_TRIBUTAVEL_02":
                if (invalidPisAliquota(pis)) return !0;
                break;

              case "OPERACAO_TRIBUTAVEL_05":
                if (!pis.calculationTypeST) return !0;
              ...
              case "OUTRAS_99":
                if (!pis.calculationType) return !0;
                if ("PORCENTAGEM" === pis.calculationType && invalidPisAliquota(pis)) return !0;
            }
        }
        function invalidCofins(cofins) {
            if (cofins.CST) switch (cofins.CST) {
              case "OPERACAO_TRIBUTAVEL_01":
              case "OPERACAO_TRIBUTAVEL_02":
                if (invalidCofinsAliquota(cofins)) return !0;
                break;

              case "OPERACAO_TRIBUTAVEL_05":
                if (!cofins.calculationTypeST) return !0;
                if ("PORCENTAGEM" === cofins.calculationTypeST && invalidCofinsAliquotaST(cofins)) return !0;
                break;
              ...
              case "OUTRAS_ENTRADAS_98":
              case "OUTRAS_99":
                if (!cofins.calculationType) return !0;
                if ("PORCENTAGEM" === cofins.calculationType && invalidCofinsAliquota(cofins)) return !0;
            }
        }
        function invalidIpi(ipi) {
            if (ipi.CST) switch (ipi.CST) {
              case "ENTRADA_RECUPERACAO_CREDITO_00":
              case "OUTRAS_ENTRADAS_49":
              case "SAIDA_TRIBUTADA_50":
              case "OUTRAS_SAIDAS_99":
                if (!ipi.ipiCalculationType || "PORCENTAGEM" === ipi.ipiCalculationType && invalidIpiAliquota(ipi)) return !0;
            }
        }
        function invalidIcmsNormal(icms) {
            if (icms.CST) switch (icms.CST) {
              case "INTEGRALMENTE_00":
                if (invalidIcmsBase(icms)) return !0;
                break;

              case "COBRANCA_ST_10":
                if (invalidIcmsBase(icms) || invalidIcmsStBase(icms)) return !0;
                break;

              case "OUTRAS_COM_PARTILHA_90":
              case "COBRANCA_ST_10_COM_PARTILHA":
                if (invalidIcmsBase(icms) || invalidIcmsStBase(icms) || !icms.UFST) return !0;
                break;

              case "REDUCAO_BC_20":
                if (invalidIcmsBase(icms) || invalidIcmsDeson(icms)) return !0;
                break;
              ...
              case "SUSPENSAO_50":
                if (invalidIcmsDeson(icms)) return !0;
                break;
              ...
              case "DIFERIMENTO_51":
                if (invalidIcmsBase(icms) || invalidIcmsDife(icms)) return !0;
                break;

              case "COBRADO_ANTERIORMENTE_POR_ST_60":
                if (invalidIcmsStRetidoAnter(icms)) return !0;
                break;

              case "ST_REDUCAO_BC_70":
              case "OUTROS_90":
                if (invalidIcmsBase(icms) || invalidIcmsDeson(icms) || invalidIcmsStBase(icms)) return !0;
            }
        }
        function invalidIcmsSimples(icms) {
            if (icms.CSOSN) switch (icms.CSOSN) {
              case "CREDITO_101":
                if (null == icms.vCredICMSSN) return !0;
                break;

              case "CREDITO_COM_ST_201":
                if (invalidBaseStSimples(icms) || invalidAliquotaGroup(icms)) return !0;
                break;

              case "SEM_CREDITO_COM_ST_202":
              case "RECEITA_BRUTA_COM_ST_203":
                if (invalidBaseStSimples(icms)) return !0;
                break;

              case "ANTECIPACAO_ST_500":
                if (invalidIcmsStRetidoAnterSimples(icms)) return !0;
                break;

              case "OUTROS_900":
                if (invalidBaseStSimples(icms) || invalidAliquotaGroup(icms) || invalidIcmsBase(icms)) return !0;
            }
        }
        ...
        function invalidBaseStSimples(icms) {
            return !icms.modBCST || !icms.vBCST || null == icms.pICMSST || !icms.vICMSST;
        }
        function invalidAliquotaGroup(icms) {
            return null == icms.pCredSN || null == icms.vCredICMSSN;
        }
        function doSave() {
        ...
        function doErr(err) {
            if (Array.isArray(err.data)) {
                var _values = err.data.map(function(data) {
                    return data.destinations = unmapEnum(data.destinations, $scope.stateDestinationList), 
                    data.origins = unmapEnum(data.origins, $scope.stateOriginList), data;
                });
                $uibModal.open({
                    size: "lg",
            ...
            } else GumgaAlert.createWarningMessage("Tributação Incorreta", err.data.details);
        }
        function unmapEnum(valueArr, dtoArr) {
            return valueArr = valueArr || [], valueArr.map(function(data) {
        ...
        function invalidCofinsAliquotaST(cofins) {
            return !cofins.vBCST || null == cofins.pCOFINSST || !cofins.vCOFINSST;
        }
        function invalidCofinsAliquota(cofins) {
            return !cofins.vBC || null == cofins.pCOFINS || !cofins.vCOFINS;
        }
        function invalidIpiAliquota(ipi) {
            return !ipi.vBC || null == ipi.pIPI || !ipi.vIPI;
        }
        function invalidPisAliquotaST(pis) {
            return !pis.vBCST || null == pis.pPISST || !pis.vPISST;
        }
        function invalidPisAliquota(pis) {
            return !pis.vBC || null == pis.pPIS || !pis.vPIS;
        }
        function invalidIcmsBase(icms) {
            return !icms.modBC || !icms.vBC || null == icms.pICMS || !icms.vICMS;
        }
        ...
        function invalidIcmsStBase(icms) {
            return !(icms.modBCST && icms.pRedBCST && null != icms.pMVAST && icms.vBCST && null != icms.pICMSST && icms.vICMSST);
        }
        ...
        function invalidIcmsDife(icms) {
            return !icms.vICMSOp || null == icms.pDif || !icms.vICMSDif;
        }
        ...
        function mountIcms(icms) {
            ...
            return "INTEGRALMENTE_00" !== icms.CST && "COBRANCA_ST_10" !== icms.CST && "OUTRAS_COM_PARTILHA_90" !== icms.CST && "COBRANCA_ST_10_COM_PARTILHA" !== icms.CST && "REDUCAO_BC_20" !== icms.CST && "DIFERIMENTO_51" !== icms.CST && "ST_REDUCAO_BC_70" !== icms.CST && "OUTROS_90" !== icms.CST || (obj.modBC = icms.modBC, 
            obj.pICMS = icms.pICMS, obj.vBC = icms.vBC, obj.vICMS = icms.vICMS), "COBRANCA_ST_10" !== icms.CST && "OUTRAS_COM_PARTILHA_90" !== icms.CST && "COBRANCA_ST_10_COM_PARTILHA" !== icms.CST && "ISENTA_COM_ST_30" !== icms.CST && "ST_REDUCAO_BC_70" !== icms.CST && "OUTROS_90" !== icms.CST || (obj.modBCST = icms.modBCST, 
            obj.pICMSST = icms.pICMSST, obj.pMVAST = icms.pMVAST, obj.pRedBCST = icms.pRedBCST, 
            obj.vBCST = icms.vBCST, obj.vICMSST = icms.vICMSST), "OUTRAS_COM_PARTILHA_90" !== icms.CST && "COBRANCA_ST_10_COM_PARTILHA" !== icms.CST || (obj.UFST = icms.UFST), 
            "REDUCAO_BC_20" !== icms.CST && "ISENTA_COM_ST_30" !== icms.CST && "ISENTA_40" !== icms.CST && "NAO_TRIBUTADA_41" !== icms.CST && "SUSPENSAO_50" !== icms.CST && "ST_REDUCAO_BC_70" !== icms.CST && "OUTROS_90" !== icms.CST || (obj.vICMSDeson = icms.vICMSDeson, 
            obj.motDesICMS = icms.motDesICMS), "NAO_TRIBUTADA_41_ICMSST" === icms.CST && (obj.vBCSTRet = icms.vBCSTRet, 
            obj.vBCSTDest = icms.vBCSTDest, obj.vICMSSTDest = icms.vICMSSTDest, obj.vICMSSTRet = icms.vICMSSTRet), 
            "DIFERIMENTO_51" === icms.CST && (obj.pDif = icms.pDif, obj.vICMSDif = icms.vICMSDif, 
            obj.vICMSOp = icms.vICMSOp), "COBRADO_ANTERIORMENTE_POR_ST_60" === icms.CST && (obj.vBCSTRet = icms.vBCSTRet, 
            obj.vICMSSTRet = icms.vICMSSTRet), obj;
        }
        function mountIcmsSimples(icms) {
            ...
            return "CREDITO_101" !== icms.CSOSN && "CREDITO_COM_ST_201" !== icms.CSOSN && "OUTROS_900" !== icms.CSOSN || (obj.pCredSN = icms.pCredSN, 
            obj.vCredICMSSN = icms.vCredICMSSN), "CREDITO_COM_ST_201" !== icms.CSOSN && "SEM_CREDITO_COM_ST_202" !== icms.CSOSN && "RECEITA_BRUTA_COM_ST_203" !== icms.CSOSN && "OUTROS_900" !== icms.CSOSN || (obj.modBCST = icms.modBCST, 
            obj.pICMSST = icms.pICMSST, obj.pMVAST = icms.pMVAST, obj.pRedBCST = icms.pRedBCST, 
            obj.vBCST = icms.vBCST, obj.vICMSST = icms.vICMSST), "ANTECIPACAO_ST_500" === icms.CSOSN && (obj.vBCSTRet = icms.vBCSTRet, 
            obj.vICMSSTRet = icms.vICMSSTRet), "OUTROS_900" === icms.CSOSN && (obj.modBC = icms.modBC, 
            obj.vBC = icms.vBC, obj.pRedBC = icms.pRedBC, obj.pICMS = icms.pICMS, obj.vICMS = icms.vICMS), 
            obj;
        }
        function mountPis(pis) {
            ...
            switch (pis.CST) {
              case "OPERACAO_TRIBUTAVEL_05":
                obj.calculationTypeST = pis.calculationTypeST, "PORCENTAGEM" === pis.calculationTypeST && (obj.pPISST = pis.pPISST, 
                obj.vBCST = pis.vBCST, obj.vPISST = pis.vPISST);
                break;

              case "OPERACAO_TRIBUTAVEL_01":
              case "OPERACAO_TRIBUTAVEL_02":
                obj.pPIS = pis.pPIS, obj.vBC = pis.vBC, obj.vPIS = pis.vPIS;
                break;
              ...
              case "OUTRAS_ENTRADAS_98":
              case "OUTRAS_99":
                obj.calculationType = pis.calculationType, "PORCENTAGEM" === pis.calculationType && (obj.pPIS = pis.pPIS, 
                obj.vBC = pis.vBC, obj.vPIS = pis.vPIS);
            }
            return obj;
        }
        function mountCofins(cofins) {
            ...
            switch (cofins.CST) {
              case "OPERACAO_TRIBUTAVEL_05":
                obj.calculationTypeST = cofins.calculationTypeST, "PORCENTAGEM" === cofins.calculationTypeST && (obj.pCOFINSST = cofins.pCOFINSST, 
                obj.vBCST = cofins.vBCST, obj.vCOFINSST = cofins.vCOFINSST);
                break;

              case "OPERACAO_TRIBUTAVEL_01":
              case "OPERACAO_TRIBUTAVEL_02":
                obj.pCOFINS = cofins.pCOFINS, obj.vBC = cofins.vBC, obj.vCOFINS = cofins.vCOFINS;
                break;
              ...
              case "OUTRAS_ENTRADAS_98":
              case "OUTRAS_99":
                obj.calculationType = cofins.calculationType, "PORCENTAGEM" === cofins.calculationType && (obj.pCOFINS = cofins.pCOFINS, 
                obj.vBC = cofins.vBC, obj.vCOFINS = cofins.vCOFINS);
            }
            return obj;
        }
        function mountIpi(ipi) {
            ...
            switch (ipi.CST) {
              ...
              case "SAIDA_TRIBUTADA_50":
              case "OUTRAS_SAIDAS_99":
                obj.ipiCalculationType = ipi.ipiCalculationType, "PORCENTAGEM" === ipi.ipiCalculationType && (obj.pIPI = ipi.pIPI, 
                obj.vBC = ipi.vBC, obj.vIPI = ipi.vIPI);
            }
            return obj;
        }
        ...
        $scope.taxationGroup.execute("reset"), $scope.entity = angular.copy(entity.data), 
        $scope.pis = $scope.entity.taxationPIS || {}, $scope.icms = $scope.entity.taxationICMS || {}, 
        $scope.cofins = $scope.entity.taxationCOFINS || {}, $scope.ipi = $scope.entity.taxationIPI || {}, 
        $scope.continue = {}, $scope.entity.operationTypes = $scope.entity.operationTypes || [], 
        $scope.entity.origins = $scope.entity.origins || [], $scope.entity.destinations = $scope.entity.destinations || [], 
        $scope.entity.personGroups = $scope.entity.personGroups || [], $scope.entity.productGroups = $scope.entity.productGroups || [], 
        $scope.vICMSd = $scope.vICMSd || 0, $scope.showICMS = !1, $scope.showPIS = !1, $scope.showCOFINS = !1, 
        $scope.openTaxation = !1, $scope.step1 = !1, $scope.configOpen = !1, $scope.mensagemICMSList = [], 
        $scope.mensagemPISList = [], $scope.mensagemIPIList = [], $scope.mensagemCOFINSList = [], 
        $scope.formulaIcmsBCList = [], $scope.formulaValorIcms = [], $scope.formulaBaseIcmsSt = [], 
        $scope.formulaValorIcmsSt = [], $scope.formulaValorIcmsDeson = [], $scope.formulaIcmsStDeson = [], 
        $scope.fomulasBaseIcmsRet = [], $scope.formulaValorIcmsRet = [], $scope.formulaBaseIcmsDest = [], 
        $scope.formulaValorIcmsDest = [], $scope.formulaValorIcmsOpe = [], $scope.formulaBasePis = [], 
        $scope.formulaBasePisST = [], $scope.formulaValorPisST = [], $scope.formulaValorPis = [], 
        $scope.formulaBaseCofins = [], $scope.formulaBaseCofinsST = [], $scope.formulaValorCofinsST = [], 
        $scope.formulaValorCofins = [], $scope.cfopList = [], $scope.stateOriginConflicts = [], 
        $scope.stateDestinationsConflicts = [], $scope.personGroupConflicts = [], $scope.productGroupConflicts = [], 
        $scope.operationConflicts = [], $scope.entity.id && ($scope.openTaxation = !0, $scope.configOpen = !1), 
        CompanyService.getCurrentCompany().then(function(data) {
            $scope.icmsNormal = "REGIME_NORMAL" === data.data.crt, $scope.icmsNormal ? $scope.tribute = [ "ICMS", "PIS", "COFINS", "IPI" ] : ($scope.tribute = [ "ICMS Simples", "PIS", "COFINS", "IPI" ], 
            $scope.icms.CST = "");
        }), OperationTypeService.all().then(function(data) {
            $scope.operationTypesList = data.data.values, $timeout(function() {
                $scope.entity.operationTypes = entity.data.operationTypes || [], $scope.entity.operationTypes = $scope.entity.operationTypes.map(function(data) {
            ...
            "tribute" === panel || "operation" === panel || "origin" === panel ? ($scope.configOpen = !0, 
            $scope.openTaxation = !1, $scope.step2 = !1) : ($scope.configOpen = !0, $scope.openTaxation = !1, 
            $scope.step2 = !0);
        }, $scope.entity.id || $scope.openPanel("tribute"), $scope.blockBtnTributos = function(entity) {
            return 0 === entity.operationTypes.length || 0 === entity.origins.length || 0 === entity.destinations.length || 0 === entity.personGroups.length || 0 === entity.productGroups.length;
        }, $scope.isIcmsAble = function(entity) {
            return !entity.CST || "ISENTA_COM_ST_30" === entity.CST || "NAO_TRIBUTADA_41_ICMSST" === entity.CST || "COBRADO_ANTERIORMENTE_POR_ST_60" === entity.CST;
        }, $scope.isIcmsStandartGroupAble = function(entity) {
            return "INTEGRALMENTE_00" === entity.CST || "COBRANCA_ST_10" === entity.CST || "COBRANCA_ST_10_COM_PARTILHA" === entity.CST || "REDUCAO_BC_20" === entity.CST || "DIFERIMENTO_51" === entity.CST || "ST_REDUCAO_BC_70" === entity.CST || "OUTRAS_COM_PARTILHA_90" === entity.CST || "OUTROS_90" === entity.CST;
        }, $scope.isIcmsDesoGroupAble = function(entity) {
            return "REDUCAO_BC_20" === entity.CST || "ISENTA_40" === entity.CST || "NAO_TRIBUTADA_41" === entity.CST || "SUSPENSAO_50" === entity.CST || "ST_REDUCAO_BC_70" === entity.CST || "OUTROS_90" === entity.CST;
        }, $scope.isIcmsRedGroupAble = function(entity) {
            return "COBRANCA_ST_10_COM_PARTILHA" === entity.CST || "REDUCAO_BC_20" === entity.CST || "DIFERIMENTO_51" === entity.CST || "ST_REDUCAO_BC_70" === entity.CST || "OUTRAS_COM_PARTILHA_90" === entity.CST || "OUTROS_90" === entity.CST;
        }, $scope.isIcmsStAble = function(entity) {
            return !entity.CST || "INTEGRALMENTE_00" === entity.CST || "REDUCAO_BC_20" === entity.CST || "ISENTA_40" === entity.CST || "NAO_TRIBUTADA_41" === entity.CST || "SUSPENSAO_50" === entity.CST || "DIFERIMENTO_51" === entity.CST;
        }, $scope.isIcmsStStandartGroupAble = function(entity) {
            return "NAO_TRIBUTADA_41_ICMSST" === entity.CST || "COBRADO_ANTERIORMENTE_POR_ST_60" === entity.CST;
        }, $scope.getCfopIcms = function(value) {
            return value = value || "", CfopService.getAdvancedSearch("lower(obj.codigo) like lower('%" + value + "%') or lower(obj.descricao) like lower('%" + value + "%')").then(function(data) {
            ...
            return !entity.CST || "ENTRADA_RECUPERACAO_CREDITO_00" !== entity.CST && "OUTRAS_ENTRADAS_49" !== entity.CST && "SAIDA_TRIBUTADA_50" !== entity.CST && "OUTRAS_SAIDAS_99" !== entity.CST;
        }, $scope.isPisAble = function(entity) {
            return !entity.CST || "OPERACAO_TRIBUTAVEL_04" === entity.CST || "OPERACAO_TRIBUTAVEL_03" === entity.CST || "OPERACAO_TRIBUTAVEL_06" === entity.CST || "OPERACAO_TRIBUTAVEL_07" === entity.CST || "SEM_INCIDENCIA_08" === entity.CST || "COM_SUSPENSAO_09" === entity.CST;
        }, $scope.isPisOperationTypeUnable = function(entity) {
            return entity.CST && ($scope.isPisAble(entity) || "OPERACAO_TRIBUTAVEL_01" === entity.CST || "OPERACAO_TRIBUTAVEL_02" === entity.CST);
        }, $scope.isPisAliquotaAble = function(entity) {
            return $scope.isPisOperationTypeUnable(entity) || "PORCENTAGEM" === entity.calculationType;
        }, $scope.isCofinsAble = function(entity) {
            return !entity.CST || "OPERACAO_TRIBUTAVEL_04" === entity.CST || "OPERACAO_TRIBUTAVEL_03" === entity.CST || "OPERACAO_TRIBUTAVEL_06" === entity.CST || "OPERACAO_TRIBUTAVEL_07" === entity.CST || "SEM_INCIDENCIA_08" === entity.CST || "COM_SUSPENSAO_09" === entity.CST;
        }, $scope.isCofinsOperationTypeUnable = function(entity) {
            return entity.CST && ($scope.isCofinsAble(entity) || "OPERACAO_TRIBUTAVEL_01" === entity.CST || "OPERACAO_TRIBUTAVEL_02" === entity.CST);
        }, $scope.isCofinsAliquotaAble = function(entity) {
            return $scope.isCofinsOperationTypeUnable(entity) || "PORCENTAGEM" === entity.calculationType;
        }, $scope.saveDisabled = function(entity, icms, pis, cofins, ipi) {
            return $scope.icmsNormal && invalidIcmsNormal(icms) || !$scope.icmsNormal && invalidIcmsSimples(icms) || invalidPis(pis) || invalidCofins(cofins) || invalidIpi(ipi);
        }, $scope.update = function(entity, icms, pis, cofins, ipi) {
            entity.destinations = entity.destinations.map(mapEnum), entity.origins = entity.origins.map(mapEnum), 
            delete entity.taxationIPI, delete entity.taxationPIS, delete entity.taxationCOFINS, 
            delete entity.taxationICMS, ipi = angular.copy(ipi), icms = angular.copy(icms), 
            pis = angular.copy(pis), cofins = angular.copy(cofins), ipi.CST && (entity.taxationIPI = mountIpi(ipi)), 
            $scope.icmsNormal && icms.CST ? entity.taxationICMS = mountIcms(icms) : !$scope.icmsNormal && icms.CSOSN && (entity.taxationICMS = mountIcmsSimples(icms)), 
            entity.taxationICMS && $scope.isFCPVisible(entity.taxationICMS) && (entity.taxationICMS.pICMSUFDest = icms.pICMSUFDest, 
            entity.taxationICMS.pFCPUFDest = icms.pFCPUFDest), pis.CST && (entity.taxationPIS = mountPis(pis)), 
            cofins.CST && (entity.taxationCOFINS = mountCofins(cofins)), $rootScope.$emit("hideNextErrorMessage"), 
            TaxationGroupService.saveValiding(entity).then(doSave, doErr);
        }, $scope.showAliquotaGroup = function(icms) {
            return "CREDITO_101" === icms.CSOSN || "CREDITO_COM_ST_201" === icms.CSOSN || "OUTROS_900" === icms.CSOSN;
        }, $scope.showIcmsStSimple = function(icms) {
            return "CREDITO_COM_ST_201" === icms.CSOSN || "SEM_CREDITO_COM_ST_202" === icms.CSOSN || "RECEITA_BRUTA_COM_ST_203" === icms.CSOSN || "OUTROS_900" === icms.CSOSN;
        }, $scope.showSimples = function(icms) {
            return "CREDITO_101" === icms.CSOSN || "CREDITO_COM_ST_201" === icms.CSOSN || "OUTROS_900" === icms.CSOSN;
        }, $scope.showSimplesSt = function(icms) {
            return "CREDITO_COM_ST_201" === icms.CSOSN || "SEM_CREDITO_COM_ST_202" === icms.CSOSN || "RECEITA_BRUTA_COM_ST_203" === icms.CSOSN || "ANTECIPACAO_ST_500" === icms.CSOSN || "OUTROS_900" === icms.CSOSN;
        }, $scope.isFCPVisible = function(icms) {
            return "IMUNE_300" !== icms.CSOSN && "NAO_TRIBUTADA_400" !== icms.CSOSN && "NAO_TRIBUTADA_41" !== icms.CST && "NAO_TRIBUTADA_41_ICMSST" !== icms.CST;
    ...
    var modalConflito = __webpack_require__(19);
    ...
    function TaxSettingsListController(TaxationGroupService, $scope, gumgaController) {
        ...
        }, $scope.taxationGroup.execute("reset"), $scope.taxationGroup.methods.getLatestOperation(), 
    ...
    "use strict";
    __webpack_require__(0), module.exports = angular.module("app.taxsettings.controllers", [ "app.taxsettings.services", "ui.router" ]).controller("TaxSettingsFormController", __webpack_require__(7)).controller("ModalConflitoController", __webpack_require__(6)).controller("TaxSettingsListController", __webpack_require__(8));
}, function(module, exports, __webpack_require__) {
    "use strict";
    __webpack_require__(9), __webpack_require__(0);
    var list = __webpack_require__(18), form = __webpack_require__(17);
    ...
    function CodigoEnquadramentoIpiService(GumgaRest, apiLocation) {
        return new GumgaRest(apiLocation + "/api/codigoenquadramentoipi");
    }
    CodigoEnquadramentoIpiService.$inject = [ "GumgaRest", "apiLocation" ], module.exports = CodigoEnquadramentoIpiService;
}, function(module, exports, __webpack_require__) {
    "use strict";
    function FormulaService(GumgaRest, apiLocation) {
        return new GumgaRest(apiLocation + "/api/formula");
    }
    FormulaService.$inject = [ "GumgaRest", "apiLocation" ], module.exports = FormulaService;
}, function(module, exports, __webpack_require__) {
    "use strict";
    function MensagemService(GumgaRest, apiLocation) {
        var service = new GumgaRest(apiLocation + "/api/mensagem");
        return service.getAttributeMessageNames = function() {
            return service.extend("get", "/attributemessagenames");
        }, service.getTiposMensagem = function() {
            return service.extend("get", "/tiposmensagem");
        }, service;
    }
    MensagemService.$inject = [ "GumgaRest", "apiLocation" ], module.exports = MensagemService;
}, function(module, exports, __webpack_require__) {
    "use strict";
    function TaxationGroupService(GumgaRest, apiLocation) {
        var service = new GumgaRest(apiLocation + "/api/taxationgroup");
        return service.saveValiding = function(entity) {
            return entity.id ? this.extend("put", "/validatesave", entity) : this.extend("post", "/validatesave", entity);
